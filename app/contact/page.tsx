...
export const metadata: Metadata = {
  title: "Contact",
  description:
    "Get in touch with me. Questions, feedback, or partnerships welcome.",
};
        ...
        <div className="mx-auto max-w-6xl px-4 py-12 md:px-6 md:py-16">
          ...
          <FadeIn direction="down" className="max-w-2xl">
            ...
            <p className="mt-4 text-pretty text-lg leading-relaxed text-muted-foreground">
              Have a question, a story pitch, or just want to say hello? Fill
              out the form below or reach us through any of the channels listed
